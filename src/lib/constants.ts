...
export const HOME_FAQ: FaqItem[] = [
  ...
  { question: "Do you serve my area?", answer: `We serve 200+ cities across all 50 states. Call ${PHONE} and our dispatch team will check availability in your zip code in under 60 seconds.` },
];
...
export const SERVICE_AREAS_TN = {
  middle: [
    ...
    { name: "Clarksville", slug: null },
    { name: "Gallatin", slug: null },
    { name: "Lebanon", slug: null },
    { name: "Smyrna", slug: null },
    { name: "Nolensville", slug: null },
    { name: "Columbia", slug: null },
    { name: "La Vergne", slug: null },
    { name: "Goodlettsville", slug: null },
    { name: "Thompson's Station", slug: null },
  ],
  west: [
    { name: "Germantown", slug: null },
    { name: "Collierville", slug: null },
    { name: "Bartlett", slug: null },
    { name: "Arlington", slug: null },
    { name: "Lakeland", slug: null },
    { name: "Memphis", slug: null },
    { name: "Millington", slug: null },
  ],
  east: [
    { name: "Knoxville", slug: null },
    { name: "Farragut", slug: null },
    { name: "Chattanooga", slug: null },
    { name: "Maryville", slug: null },
    { name: "Oak Ridge", slug: null },
    { name: "Cleveland", slug: null },
    { name: "Cookeville", slug: null },
    { name: "Kingsport", slug: null },
    { name: "Johnson City", slug: null },
  ],
};
